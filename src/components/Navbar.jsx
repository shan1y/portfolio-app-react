  ...
  return (
    <div className="fixed z-10 w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      <ul className="hidden md:flex">
        ...
        <li>
          <Link  class="hover:text-[#DB2777]" to="contact" offset={0} smooth={true} duration={500}>
            Contact
          </Link>
        </li>
      </ul>
      ...
      >
        ...
        <li className="py-6 text-4xl">
          {" "}
          <Link class="hover:text-[#DB2777]" onClick={handleClick} to="work" offset={-70} smooth={true} duration={500}>
            Projects
          </Link>
        </li>
        <li className="py-6 text-4xl">
          {" "}
          <Link class="hover:text-[#DB2777]" onClick={handleClick} to="contact"  offset={-20} smooth={true} duration={500}>
            Contact
          </Link>
        </li>
      </ul>
